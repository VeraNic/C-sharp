...
static void Main(string[] args)
    {
        ...
        Console.WriteLine("Задача 1. На ввод подаётся номер четверти. Создаются 3 случайные точки в этой четверти. ");
        Console.WriteLine(
        ...
        Console.Write("Созданы три случайные точки в указанной четверти: ");
        ...
        Console.Write("Варианты маршрутов: OA1A2A3 = " + Math.Round(OA1A2A3, 3));
        double OA1A3A2 = OA1 + A1A3 + A2A3;
        Console.Write(". OA1A3A2 = " + Math.Round(OA1A3A2, 3));
        double OA2A1A3 = OA2 + A1A2 + A1A3;
        Console.Write(". OA2A1A3 = " + Math.Round(OA2A1A3, 3));
        double OA2A3A1 = OA2 + A2A3 + A1A3;
        Console.Write(". OA2A3A1 = " + Math.Round(OA2A3A1, 3));
        double OA3A1A2 = OA3 + A1A3 + A1A2;
        Console.Write(". OA3A1A2 = " + Math.Round(OA3A1A2, 3));
        double OA3A2A1 = OA3 + A2A3 + A1A2;
        Console.WriteLine(". OA3A2A1 = " + Math.Round(OA3A2A1, 3) + ".");
        Console.WriteLine("");
        ...
        Console.Write("его длина равна " + Math.Round(bestway, 3) + ".");
    }
